...
<div class="container cursive">
  ...
  <img src = "../favicon.png" alt="" width="100px"><br><br>
	<p>SmartPoultry adalah sistem peternakan ayam berbasis Internet of Things yang memungkinkan pengguna untuk dapat mmemonitor dan mengontrol keadaan kandang ayam kapanpun dan dimanapun.</p>		
	<br>
</div>
<div class="clear"></div>
<?php
